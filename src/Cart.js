...
class Cart extends React.Component {
    ...
    await fetch(
      ...
      .then(
        (result) => {
          ...
          this.setState({ cartItem: result.cart });
        },
        (error) => {
          console.log(error);
        }
  ...
  render() {
    ...
    //console.log(cartItem[0].image);
    return (
      <>
        {/* <div className="new-pm-backdrop">
          <div className="new-pm-container">
            <div
            ...
            <form className="Cart Drawer__Content">
              ...
              <div className="Drawer__footer">
                ...
                <p className="price-text">
                  Subtotal
                  <span className="wh-original-price">Rs. 9,136.00</span>
                </p>
                <div className="gokwik-checkout">
                  <button id="button-gokwik">
                    <div className="btn-text">
                      <div>Pay via UPI / COD</div>
                      <div>Extra 5% off on UPI</div>
                    </div>
